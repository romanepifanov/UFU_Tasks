...
namespace TaskTwo.Controllers
{
    public class ConsoleController
    {
        ...
        private void AddCar()
        {
            Console.Clear();
            Console.ForegroundColor = ConsoleColor.Blue;
            Console.WriteLine("Введите данные через запятую пример: Ford Focus II, 2007, 245000 руб, Хэтчбек 5 дверей, Россия");
            Console.ForegroundColor = ConsoleColor.White;
            ...
            try
            {
                ...
                sellController.AddCar(new Car(items[0], Int32.Parse(items[1]), items[2], items[3], items[4]));
...
//Ford Focus II, 2007, 245000 руб, Хэтчбек 5 дв., Россия
//Audi, 2011, 600000 руб, Хэтчбек 5 дв., Россия;
//Daewoo nexia, 2011, 200000 руб, Хэтчбек 5 дв., Россия
